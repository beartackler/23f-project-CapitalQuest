...
CREATE TABLE IF NOT EXISTS internship (
    ...
    CONSTRAINT fk_int_int FOREIGN KEY (company_id)
...
CREATE TABLE IF NOT EXISTS course_student(
    ...
    CONSTRAINT fk_course_student FOREIGN KEY (course_id) REFERENCES course(course_id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS course_simulation(
    ...
    CONSTRAINT fk_simulation_course FOREIGN KEY (course_id) REFERENCES course(course_id) ON UPDATE CASCADE ON DELETE CASCADE,
